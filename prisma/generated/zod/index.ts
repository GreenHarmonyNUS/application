...
export const UserScalarFieldEnumSchema = z.enum(['id','email','emailVerified','phone','name','gender','image','maritalStatus','volunteerStatus','preferredName','preferredCommunication','preferredStartDate','birthYear','residentialDistrict','roles','emergencyName','emergencyRelationship','emergencyPhone','created_at','updated_at']);
